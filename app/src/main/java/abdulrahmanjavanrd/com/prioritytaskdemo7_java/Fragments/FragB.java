...
public class FragB extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        showItems = view.findViewById(R.id.show_item_button);

        showItems.setOnClickListener(view1 -> {
            callIntent();
        });
//        setUpRecycler();
        return view ;
    ...
    {
        ICallListMaterial material = (ICallListMaterial) getActivity();
        material.callListMaterial();
    }
}
